...
(function () {
  ...
  function seed() {
    ...
    for (var m2 = 5; m2 <= 9; m2++) {
      EVENTS.push(ev(y, m2, 5, "pay", "Аренда офиса — 120 000 ₽", "ООО «ТехноСфера»", "Ежемесячно", 3));
      EVENTS.push(ev(y, m2, 10, "pay", "Интернет и связь — 8 500 ₽", "ООО «ТехноСфера»", "Ежемесячно", 1));
      EVENTS.push(ev(y, m2, 15, "pay", "Аренда склада — 260 000 ₽", "ООО «Логистик Групп»", "Ежемесячно", 3));
      EVENTS.push(ev(y, m2, 25, "pay", "Лизинг оборудования — 95 000 ₽", "ООО «МедФарм»", "Ежемесячно", 3));
    }
    EVENTS.push(ev(y, 7, 1, "pay", "Страховка автопарка — 340 000 ₽", "ООО «Логистик Групп»", "Ежегодно", 7));
