...
Поддерживаемые типы черновиков документов 1С (создание НЕПРОВЕДЁННОГО документа в базе клиента): платёж исходящий/входящий, ЭСФ (счёт-фактура выданный — Document_СчетФактураВыданный), счёт на оплату, поступление товаров/услуг, реализация товаров/услуг, акт сверки, доверенность. ЭСФ здесь — это именно 1С-документ «Счет-фактура выданный», его создание черновиком ПОДДЕРЖИВАЕТСЯ.
